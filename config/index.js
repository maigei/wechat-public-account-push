export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxcb326834d94aa21a",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d11de9473ca991eb3f9363a3c97cb75b",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "YavrsKUlfLqyCJ5sk_P9ALqr-Vo2P6TsT3d2o2tg0BU",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "重庆",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-07-01"},
        // 相遇纪念日
        {"keyword": "marry_day", date: "2021-06-21"},
        // 退伍日
  ...
  CALLBACK_TEMPLATE_ID: "d5ChbWFwywad-wvAzm3karzz3hxxF4zDZiBA-WexzAg",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "d5ChbWFwywad-wvAzm3karzz3hxxF4zDZiBA-WexzAg",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
